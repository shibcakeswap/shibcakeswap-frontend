...
import { Farm, Pool, State, NodeRound, ReduxNodeLedger, NodeLedger, ReduxNodeRound } from './types'
...
export const usePriceCakeBusd = (): BigNumber => {
  ...
  return cakeBnbFarm?.tokenPriceVsQuote && bnbBusdPrice ? bnbBusdPrice.times(cakeBnbFarm.tokenPriceVsQuote) : ZERO
}
